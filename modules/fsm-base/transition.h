#ifndef _FSM__TRANSITION_H_
#define _FSM__TRANSITION_H_
...
namespace fsm {
    ...
    public:
        __OVERRIDE_ATTR_READER__(const std::string &, name_, name)

        __ATTR_READER__(transition_type_, transition_type)
